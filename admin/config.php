<?php
// HTTP
define('HTTP_SERVER', 'https://opencart-laophatgia.c9users.io/admin/');
define('HTTP_CATALOG', 'https://opencart-laophatgia.c9users.io/');

// HTTPS
define('HTTPS_SERVER', 'https://opencart-laophatgia.c9users.io/admin/');
define('HTTPS_CATALOG', 'https://opencart-laophatgia.c9users.io/');
