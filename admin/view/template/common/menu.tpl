<ul id="menu">
  <li ><a href="<?php echo $category; ?>"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_category; ?></span></a></li>
  <li><a href="<?php echo $product; ?>"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_product; ?></span></a></li>
  <li><a href="<?php echo $pavmegamenu; ?>"><i class="fa fa-info-circle fa-fw"></i> <span>Menu chính</span></a></li>
  <li><a href="<?php echo $pavverticalmenu; ?>"><i class="fa fa-tags fa-fw"></i> <span>Menu Dọc</span></a></li>
  <li><a href="<?php echo $module; ?>"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_module; ?></span></a></li>
  ...
  <li id="extension"><a class="parent"><i class="fa fa-puzzle-piece fa-fw"></i> <span><?php echo "Phần mở rộng"; ?></span></a>
    <ul>
      <li><a href="<?php echo $report_product_viewed; ?>"><?php echo $text_report_product_viewed; ?></a></li>
